    ...
    <main id="main" className="wrap page" tabIndex={-1}>
      <TerminalWindow path="~/oracle">
        ...
        <p className="page-lead">
          ...
          Gabriel&apos;s experience, the projects, or how this platform works.
        </p>
        <p className="page-lead">What keeps it honest:</p>
        ...
        <p className="page-lead">The tabs above the console each do one thing:</p>
        <ul className="lead-guide">
          <li><b>Ask</b> — the conversation itself</li>
          <li><b>Analyze a JD</b> — reads a job description and maps it honestly against the record</li>
          <li><b>Tailor résumé</b> — reorders the real facts for a specific role, never inventing new ones</li>
          <li><b>Theme studio</b> — lets the model restyle the site within strict guard-rails</li>
          <li><b>Local model</b> — runs a small self-hosted model on my own hardware, with live latency and cost beside it</li>
        </ul>
        <p className="page-lead">The eval panel at the bottom publishes real measured scores.</p>
        <noscript>
          <p className="page-lead">
