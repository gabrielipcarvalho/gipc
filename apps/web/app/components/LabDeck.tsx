...
type Demo = { Panel: ComponentType; proves: string; safe: string; wide?: boolean };
...
export function LabDeck() {
  return (
    <div className="lab">
      {DEMOS.map(({ Panel, proves, safe, wide }) => (
        <div key={proves} className={wide ? "lab-wide lab-cell" : "lab-cell"}>
